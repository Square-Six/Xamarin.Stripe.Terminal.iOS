...
namespace Org.Intellij.Lang.Annotations {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='org.intellij.lang.annotations']/interface[@name='MagicConstant']"
	[Register ("org/intellij/lang/annotations/MagicConstant", "", "Org.Intellij.Lang.Annotations.IMagicConstantInvoker")]
	public partial interface IMagicConstant : global::Java.Lang.Annotation.IAnnotation {

		// Metadata.xml XPath method reference: path="/api/package[@name='org.intellij.lang.annotations']/interface[@name='MagicConstant']/method[@name='flags' and count(parameter)=0]"
		[Register ("flags", "()[J", "GetFlagsHandler:Org.Intellij.Lang.Annotations.IMagicConstantInvoker, Xamarin.Stripe.Terminal.Android")]
		long[] Flags ();

		// Metadata.xml XPath method reference: path="/api/package[@name='org.intellij.lang.annotations']/interface[@name='MagicConstant']/method[@name='flagsFromClass' and count(parameter)=0]"
		[Register ("flagsFromClass", "()Ljava/lang/Class;", "GetFlagsFromClassHandler:Org.Intellij.Lang.Annotations.IMagicConstantInvoker, Xamarin.Stripe.Terminal.Android")]
		global::Java.Lang.Class FlagsFromClass ();

		// Metadata.xml XPath method reference: path="/api/package[@name='org.intellij.lang.annotations']/interface[@name='MagicConstant']/method[@name='intValues' and count(parameter)=0]"
		[Register ("intValues", "()[J", "GetIntValuesHandler:Org.Intellij.Lang.Annotations.IMagicConstantInvoker, Xamarin.Stripe.Terminal.Android")]
		long[] IntValues ();

		// Metadata.xml XPath method reference: path="/api/package[@name='org.intellij.lang.annotations']/interface[@name='MagicConstant']/method[@name='stringValues' and count(parameter)=0]"
		[Register ("stringValues", "()[Ljava/lang/String;", "GetStringValuesHandler:Org.Intellij.Lang.Annotations.IMagicConstantInvoker, Xamarin.Stripe.Terminal.Android")]
		string[] StringValues ();

		// Metadata.xml XPath method reference: path="/api/package[@name='org.intellij.lang.annotations']/interface[@name='MagicConstant']/method[@name='valuesFromClass' and count(parameter)=0]"
		[Register ("valuesFromClass", "()Ljava/lang/Class;", "GetValuesFromClassHandler:Org.Intellij.Lang.Annotations.IMagicConstantInvoker, Xamarin.Stripe.Terminal.Android")]
		global::Java.Lang.Class ValuesFromClass ();

	}

	[global::Android.Runtime.Register ("org/intellij/lang/annotations/MagicConstant", DoNotGenerateAcw=true)]
	internal partial class IMagicConstantInvoker : global::Java.Lang.Object, IMagicConstant {

		static readonly JniPeerMembers _members = new XAPeerMembers ("org/intellij/lang/annotations/MagicConstant", typeof (IMagicConstantInvoker));
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "org.intellij.lang.annotations.MagicConstant"));
			return handle;
		}
...
#pragma warning disable 0169
		...
		{
			global::Org.Intellij.Lang.Annotations.IMagicConstant __this = global::Java.Lang.Object.GetObject<global::Org.Intellij.Lang.Annotations.IMagicConstant> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
