...
namespace Org.Intellij.Lang.Annotations {
	...
	public abstract class Flow : Java.Lang.Object {
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='org.intellij.lang.annotations']/interface[@name='Flow']/field[@name='DEFAULT_SOURCE']"
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='org.intellij.lang.annotations']/interface[@name='Flow']/field[@name='DEFAULT_TARGET']"
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='org.intellij.lang.annotations']/interface[@name='Flow']/field[@name='RETURN_METHOD_TARGET']"
		[Register ("RETURN_METHOD_TARGET")]
		public const string ReturnMethodTarget = (string) "The return value of this method";

		// Metadata.xml XPath field reference: path="/api/package[@name='org.intellij.lang.annotations']/interface[@name='Flow']/field[@name='THIS_SOURCE']"
		[Register ("THIS_SOURCE")]
		public const string ThisSource = (string) "this";

		// Metadata.xml XPath field reference: path="/api/package[@name='org.intellij.lang.annotations']/interface[@name='Flow']/field[@name='THIS_TARGET']"
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='org.intellij.lang.annotations']/interface[@name='Flow']"
	[Register ("org/intellij/lang/annotations/Flow", "", "Org.Intellij.Lang.Annotations.IFlowInvoker")]
	public partial interface IFlow : global::Java.Lang.Annotation.IAnnotation {

		// Metadata.xml XPath method reference: path="/api/package[@name='org.intellij.lang.annotations']/interface[@name='Flow']/method[@name='source' and count(parameter)=0]"
		[Register ("source", "()Ljava/lang/String;", "GetSourceHandler:Org.Intellij.Lang.Annotations.IFlowInvoker, Xamarin.Stripe.Terminal.Android")]
		string Source ();

		// Metadata.xml XPath method reference: path="/api/package[@name='org.intellij.lang.annotations']/interface[@name='Flow']/method[@name='sourceIsContainer' and count(parameter)=0]"
		[Register ("sourceIsContainer", "()Z", "GetSourceIsContainerHandler:Org.Intellij.Lang.Annotations.IFlowInvoker, Xamarin.Stripe.Terminal.Android")]
		bool SourceIsContainer ();

		// Metadata.xml XPath method reference: path="/api/package[@name='org.intellij.lang.annotations']/interface[@name='Flow']/method[@name='target' and count(parameter)=0]"
		[Register ("target", "()Ljava/lang/String;", "GetTargetHandler:Org.Intellij.Lang.Annotations.IFlowInvoker, Xamarin.Stripe.Terminal.Android")]
		string Target ();

		// Metadata.xml XPath method reference: path="/api/package[@name='org.intellij.lang.annotations']/interface[@name='Flow']/method[@name='targetIsContainer' and count(parameter)=0]"
		[Register ("targetIsContainer", "()Z", "GetTargetIsContainerHandler:Org.Intellij.Lang.Annotations.IFlowInvoker, Xamarin.Stripe.Terminal.Android")]
		bool TargetIsContainer ();

	}

	[global::Android.Runtime.Register ("org/intellij/lang/annotations/Flow", DoNotGenerateAcw=true)]
	internal partial class IFlowInvoker : global::Java.Lang.Object, IFlow {

		static readonly JniPeerMembers _members = new XAPeerMembers ("org/intellij/lang/annotations/Flow", typeof (IFlowInvoker));
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "org.intellij.lang.annotations.Flow"));
			return handle;
		}
...
#pragma warning disable 0169
		...
		{
			global::Org.Intellij.Lang.Annotations.IFlow __this = global::Java.Lang.Object.GetObject<global::Org.Intellij.Lang.Annotations.IFlow> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
