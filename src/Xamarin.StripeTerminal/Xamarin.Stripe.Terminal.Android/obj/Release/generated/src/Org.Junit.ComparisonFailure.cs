...
namespace Org.Junit {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.junit']/class[@name='ComparisonFailure']"
	[global::Android.Runtime.Register ("org/junit/ComparisonFailure", DoNotGenerateAcw=true)]
	public partial class ComparisonFailure : global::Java.Lang.AssertionError {

		static readonly JniPeerMembers _members = new XAPeerMembers ("org/junit/ComparisonFailure", typeof (ComparisonFailure));
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.junit']/class[@name='ComparisonFailure']/constructor[@name='ComparisonFailure' and count(parameter)=3 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.lang.String']]"
...
#pragma warning disable 0169
		...
		{
			global::Org.Junit.ComparisonFailure __this = global::Java.Lang.Object.GetObject<global::Org.Junit.ComparisonFailure> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.NewString (__this.Actual);
		}
#pragma warning restore 0169

		public virtual unsafe string Actual {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.junit']/class[@name='ComparisonFailure']/method[@name='getActual' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Expected {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.junit']/class[@name='ComparisonFailure']/method[@name='getExpected' and count(parameter)=0]"
